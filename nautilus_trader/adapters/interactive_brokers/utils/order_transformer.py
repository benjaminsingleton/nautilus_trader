...
class OrderTransformer(ABC):
    ...
    Order transformers are responsible for converting Nautilus orders to Interactive
    Brokers orders with proper field mapping and validation.
...
class OrderTransformerFactory:
    ...
    This factory creates and caches appropriate transformers for different order types,
    providing a clean way to handle different order transformations.
